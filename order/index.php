...
$page_url = file_location('home_url','order/'.@$_GET['type'].'/');
...
$page = strtoupper($type)." ORDER | ".strtoupper(get_xml_data('company_name'));
$page_name = $page." | ".get_xml_data('seo_tag');
insert_page_visit('Order Index');
?>
<!DOCTYPE html>
<html>
	...
	<div class='j-row j-home-padding'style='padding-top:0px;'>
		...
		<div class='j-col l8 xl9 j-padding-flexible'>
			<div class='j-color4 j-account-height'>
				<?php get_header('ORDERS','back')?>
				<?php $user = 'user'; require_once(file_location('inc_path','orders_link_header.inc.php')); //order pagination?>
				<br>
			</div>
		</div>
	</div>
