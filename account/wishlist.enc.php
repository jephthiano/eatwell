...
$page_url = file_location('home_url','account/wishlist/');
require_once(file_location('inc_path','session_check.inc.php'));
//for meta
$follow_type = 'no follow';
$image_link = file_location('media_url','home/logo.png');
$page = "WISHLIST | ".strtoupper(get_xml_data('company_name'));
$page_name = $page." | ".get_xml_data('seo_tag');
insert_page_visit('wishlist');
?>
<!DOCTYPE html>
<html>
	...
	<div><?php require(file_location('inc_path','navigation.inc.php')); //navigation?></div>
		...
		<div class='j-col l8 xl9 j-padding-flexible'>
			<div class='j-color4 j-account-height'>
				<?php get_header('WISHLIST','back',-25)?>
				<?php require_once(file_location('inc_path','product_pagination.inc.php')); //view pagination?>
				<br>
			</div>
		</div>
	</div>
