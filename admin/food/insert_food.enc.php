...
$page_url = file_location('admin_url','/food/insert_food/');
$page = "INSERT FOOD";
...
<div class="j-row">
	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div class='j-padding'>
			<h2 class='j-text-color1 j-padding j-color4'><b>INSERT NEW FOOD</b></h2>
		</div>
		<div class='j-padding'>
			<a href="<?=file_location('admin_url','food/available/')?>" class="j-btn j-color1 j-right j-round j-card-4 j-bolder">Show Available Food</a>
			<br class='j-clearfix'>
		</div>
			...
			<form onsubmit="event.preventDefault();"id='insfd'enctype="multipart/form-data">
				...
				<div class='j-row'>
					...
					<div class='j-col m6 j-padding'>
						...
						<input type="number"class="j-input j-medium j-border-2 j-border-color5 j-round"placeholder="Total Available"maxlength='5'
							name="ta"id="ta"value=""style="width:100%;"/>
				...
				<div class='j-row'>
					<div class='j-col m6 j-padding'>
						...
						<textarea placeholder="Short Description"id='sd'name="sd"style="width:100%;"rows="4"class="j-input j-medium j-border-2 j-border-color5 j-color4 j-round-large"maxlength='120'></textarea>
					</div>
					<div class='j-col m6 j-padding'>
				...
				<div class='j-margin'>
					<button type='submit'id='sbtn'class="j-btn j-medium j-color1 j-round j-bolder">Insert Food</button>
				</div>
			</form>
			<span id="st"></span>
			<br><br>
